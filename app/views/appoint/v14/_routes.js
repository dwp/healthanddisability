...
var staffDataHoliday = require('../../../../app/views/appoint/v14/staff-data-holiday.js')
var staffData2 = require('../../../../app/views/appoint/v14/staff-data-2.js')
var slotsData = require('../../../../app/views/appoint/v14/slots-data.js')
var slotsData2 = require('../../../../app/views/appoint/v14/slots-data-2.js')
var moment = require('moment')
var commentsData = require('../../../../app/views/appoint/v14/data/comments.js');
var calendar = require('node-calendar');
var appointmentHistoy = require('../../../../app/views/appoint/v14/data/appointmentHistory.js');
...
router.get('*', function (req, res, next) {
  ...
  res.locals.root = "/appoint/v14"
  res.locals.manageStaffPath = "appoint/v14/capacity/manage-staff"
...
router.post('/booking/cancel-appointment', function(req, res, next){
    ...
    if(req.body.change_now === "true"){
      ...
      res.redirect('/appoint/v14/appointments-changed?reason=' + req.body.reason)
    }
...
function getCentreDetails(req, res){
  var centres = require('../../../../app/views/appoint/v14/data/centres.js'),
...
router.get('/assessment-centres', function(req, res, next){
  res.locals.centres = require('../../../../app/views/appoint/v14/data/centres.js')
  next()
})

router.get('/appointments', function(req, res, next){
  var customers = require('../../../../app/views/appoint/v14/data/referrals.js')
  if(req.query.booked){
...
router.get('/booked_appointments', function(req, res, next){
  var customers = require('../../../../app/views/appoint/v14/data/booked.js');
...
router.post('/booking/history', function(req, res, next){
    ...
    res.locals.comments = commentsData
      ...
      res.render("appoint/v14/booking/history");
...
router.post('/booking/bobby_timeline', function(req, res, next){
    ...
    commentsData.push({
      ...
      res.render("appoint/v14/booking/bobby_timeline");
...
router.get('/decision_maker', function(req, res, next){
  var customers = require('../../../../app/views/appoint/v14/data/decisionMaker.js');
  res.locals.customers = customers.map(customer => {
...
router.get('/todays_appointments', function(req, res, next){
  var customers = require('../../../../app/views/appoint/v14/data/todaysAppointments.js');
  res.locals.customers = customers.map(customer => {
...
router.get('/booking/referrals/:customerId', function(req, res, next){
  res.render("appoint/v14/booking/customer-referral");
})

router.get('/booking/booked/:customerId*', function(req, res, next){
  var customers = require('../../../../app/views/appoint/v14/data/booked.js').concat(require('../../../../app/views/appoint/v14/data/todaysAppointments.js'));
...
router.post('/booking/booked/:customerId*', function(req, res, next){
  var customers = require('../../../../app/views/appoint/v14/data/booked.js');
  var todaysCustomers = require('../../../../app/views/appoint/v14/data/todaysAppointments.js');
...
router.get('/booking/booked/:customerId', function(req, res, next){
  res.render("appoint/v14/booking/customer-booked");
})
...
router.get('/booking/decision/:customerId/details', function(req, res, next){
  res.render("appoint/v14/booking/details/contact");
})

router.get('/booking/decision/:customerId/illness', function(req, res, next){
  res.render("appoint/v14/booking/details/illness");
})

router.get('/booking/decision/:customerId/gp', function(req, res, next){
  res.render("appoint/v14/booking/details/gp");
})
...
router.get('/booking/decision/:customerId/:page', function(req, res, next){
  ...
  res.render("appoint/v14/booking/" + req.params.page);
})
...
router.get('/booking/referrals/:customerId/appointment-history', function(req, res, next){
  res.render("appoint/v14/booking/appointment-history");
})
...
router.get('/booking/booked/:customerId/arrived', function(req, res, next){
  ...
  res.render("appoint/v14/booking/details/arrived");
})
router.get('/booking/booked/:customerId/today', function(req, res, next){
  res.render("appoint/v14/booking/details/today");
})
...
router.get('/booking/booked/:customerId/timeline', function(req, res, next){
  res.render("appoint/v14/booking/timeline_booked");
})
...
router.post('/booking/booked/mendez/mendez_timeline-arrived', function(req, res, next){
    ...
    res.render("appoint/v14/booking/mendez_timeline-arrived");
  })
...
router.post('/booking/booked/:customerId/timeline-arrived', function(req, res, next){
    ...
    res.render("appoint/v14/booking/timeline-arrived");
  })
...
router.get('*/timepicker', function(req, res, next){
  var availableAppointments = require('../../../../app/views/appoint/v14/data/availableAppointments.js');
...
router.get('/booking/booked/:customerId/:pageName', function(req, res, next){
  res.render("appoint/v14/booking/" + req.params.pageName);
})


router.get('/capacity/manage-centre/:centreId*', function(req, res, next){
  getCentreDetails(req, res)
  res.locals.staff = require('../../../../app/views/appoint/v14/data/staff.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId', function(req, res, next){
  res.render("appoint/v14/capacity/manage-centre/index")
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff', function(req, res, next){
  ...
  //
  res.render("appoint/v14/capacity/manage-staff/index");
})



router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId*', function(req, res, next){
  var staff = require('../../../../app/views/appoint/v14/data/staff.js');
...
router.post('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId/staff-availability-2', function(req, res, next){
  ...
  res.render("appoint/v14/capacity/manage-staff/staff-availability-2");
  })
...
router.post('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId/staff-profile-2', function(req, res, next){
  ...
  res.render("appoint/v14/capacity/manage-staff/staff-profile-2");
  })


router.get('/capacity/manage-centre/:centreId/capacity-overbooked', function(req, res, next){

  res.locals.staff = require('../../../../app/views/appoint/v14/data/staff-overbooked.js');
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId', function(req, res, next){
  res.render("appoint/v14/capacity/manage-staff/staff-profile");
})

router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId/:section', function(req, res, next){
  res.render("appoint/v14/capacity/manage-staff/" + req.params.section);
})
...
router.get('/capacity/manage-centre/:centreId/capacity*', function(req, res, next){
  ...
  res.render("appoint/v14/capacity/manage-centre/capacity");
})
...
router.get('/capacity/manage-centre/:centreId/:section', function(req, res, next){
  res.render("appoint/v14/capacity/manage-centre/" + req.params.section)
})
...
router.post('/capacity/manage-centre/:centreId/manage-staff/new-staff-skill', function(req, res, next){
  ...
  res.render("appoint/v14/capacity/manage-staff/new-staff-skill");
});
...
router.post('/capacity/manage-centre/:centreId/manage-staff/new-staff-hours', function(req, res, next){
  ...
  res.render("appoint/v14/capacity/manage-staff/new-staff-hours");
});
...
router.post('/assessment-centres', function(req, res, next){
  ...
  res.render("appoint/v14/assessment-centres");
});
...
router.post('/capacity/new-centre-2', function(req, res, next){
  ...
  res.render("appoint/v14/capacity/new-centre-2");
});
...
router.post('/capacity/new-centre-3', function(req, res, next){
  ...
  res.render("appoint/v14/capacity/new-centre-3");
});
...
router.post('/capacity/manage-centre/:centreId/edit-centre-3', function(req, res, next){
  ...
  res.render("appoint/v14/capacity/manage-centre/edit-centre-3");
})
