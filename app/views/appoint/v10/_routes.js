...
var staffDataHoliday = require('../../../../app/views/appoint/v10/staff-data-holiday.js')
var staffData2 = require('../../../../app/views/appoint/v10/staff-data-2.js')
var slotsData = require('../../../../app/views/appoint/v10/slots-data.js')
var slotsData2 = require('../../../../app/views/appoint/v10/slots-data-2.js')
var moment = require('moment')
var commentsData = require('../../../../app/views/appoint/v10/data/comments.js');
...
router.get('*', function (req, res, next) {
  ...
  res.locals.root = "/appoint/v10"
  res.locals.manageStaffPath = "appoint/v10/capacity/manage-staff"
...
function getCentreDetails(req, res){
  var centres = require('../../../../app/views/appoint/v10/data/centres.js'),
...
router.get('/booked_appointments', function(req, res, next){
    res.locals.appointments = require('../../../../app/views/appoint/v10/data/appointments.js')
    next()
  })
...
router.post('/booking/history', function(req, res, next){
    ...
    res.locals.comments = commentsData
      ...
      res.render("appoint/v10/booking/history");
...
router.post('/booking/cancel-appointment', function(req, res, next){
    if(req.body.change_now === "true"){
      ...
      res.redirect('/appoint/v10/appointments-changed?reason=' + req.body.reason)
    }
...
router.post('/booking/bobby_timeline', function(req, res, next){
    ...
    commentsData.push({
      ...
      res.render("appoint/v10/booking/bobby_timeline");

  })

router.get('/appointment-centres', function(req, res, next){
  res.locals.centres = require('../../../../app/views/appoint/v10/data/centres.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId*', function(req, res, next){
  ...
  res.locals.staff = require('../../../../app/views/appoint/v10/data/staff.js')
  next()
})
...
router.get('/capacity/manage-centre/:centreId', function(req, res, next){
  res.render("appoint/v10/capacity/manage-centre/index")
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff', function(req, res, next){
  ...
  //
  res.render("appoint/v10/capacity/manage-staff/index");
})
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId*', function(req, res, next){
  var staff = require('../../../../app/views/appoint/v10/data/staff.js');
...
router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId', function(req, res, next){
  res.render("appoint/v10/capacity/manage-staff/staff-profile");
})

router.get('/capacity/manage-centre/:centreId/manage-staff/staff-profile/:staffId/:section', function(req, res, next){
  res.render("appoint/v10/capacity/manage-staff/" + req.params.section);
})

router.get('/capacity/manage-centre/:centreId/capacity-overbooked', function(req, res, next){

  res.locals.staff = require('../../../../app/views/appoint/v10/data/staff-overbooked.js');
...
router.get('/capacity/manage-centre/:centreId/capacity*', function(req, res, next){
  ...
  res.render("appoint/v10/capacity/manage-centre/capacity");
})
...
router.get('/capacity/manage-centre/:centreId/:section', function(req, res, next){
  res.render("appoint/v10/capacity/manage-centre/" + req.params.section)
})

router.get('/capacity/manage-centre/:centreId/manage-staff/new-staff-hours', function(req, res, next){
  res.locals.person = require('../../../../app/views/appoint/v10/data/new-staff.js');
  next()
});
...
router.get('/booking/timepicker', function(req, res, next){
  slotsData = require('../../../../app/views/appoint/v10/slots-data-booking.js')
