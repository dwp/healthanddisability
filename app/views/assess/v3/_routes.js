...
router.get('/prefillAssessment',function(req, res, next) {
  ...
  var bits = [
    ...
    ,"Broke his right leg in Aug 2015 following a motorbike accident"
    ,"He fractured the whole of his leg"
    ,"He had surgery and has 2 bolts in his knee to hold his knee together"
    ,"He also has an external fixator on his right let from his knee down"
    ,"Had been to physiotherapy twice but has been told there is only so much that they can do until his leg is healed"
    ,"They have given him basic leg exercises to do at home to help build his calf muscle"
    ,"Some days he can't to the exercises at all due to pain"
    ,"He has a lot of muscle wasting in his right thigh and says the exercises are helping a bit"
    ,"Has an appointment with the surgeon todat and is getting hospital transport there"
    ...
    ,"His specialist has advised that it will be about 4 months before he will heal and the cage will be removed"
    ,"Has had the cage on for 6 weeks now"
    ,"He says at first he couldn't do anything and was housebound"
    ,"Now he is able to do more with the use of 2 crutches"
    ,"Can weight bare a little bit now on his right leg"
